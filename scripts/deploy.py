...
def _print_run_header(
    *,
    ...
    print(f"[INFO] Disturbance: delay_steps={args.delay_steps}, noise_std={args.noise_std}")
    if checkpoint_path:
...
def main(argv: list[str] | None = None) -> int:
    ...
    args.device, _ = normalize_device_for_runtime(requested_device=args.device, wants_video=False)
    ...
    config_payload["status"] = "failed" if failed else ("interrupted" if interrupted else "completed")
